...
function SoundBar(props: {progress: number, duration: number, guessCount: number}) {
	...
	return (
		<div className="flex relative w-4/5 lg:w-1/3 h-5 border-b border-l border-r">
			<div className="flex w-full h-full">
				...
				<div id="sixth_segment" className={`${(props.guessCount > 4) ? 'bg-zinc-600' : 'bg-zinc-800'}`}></div>
			</div>
